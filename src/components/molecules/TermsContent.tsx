...
export const TermsContent: FC = memo(() => {
  ...
  return (
    <UnorderedList>
      ...
      <PrimaryHeading>第2条（利用登録）</PrimaryHeading>
      <Box>
        ...
        <UnorderedList>
          ...
          <ListItem>その他、当方が利用登録を相当でないと判断した場合</ListItem>
        </UnorderedList>
      </Box>
      <PrimaryHeading>第3条（ユーザーIDおよびパスワードの管理）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第4条（禁止事項）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第5条（本サービスの提供の停止等）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第6条（著作権）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第7条（利用制限および登録抹消）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第8条（退会）</PrimaryHeading>
      <Box>
        ユーザーは、当方の定める退会手続により、本サービスから退会できるものとします。
      </Box>
      <PrimaryHeading>第9条（保証の否認および免責事項）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第10条（サービス内容の変更等）</PrimaryHeading>
      <Box>
        当方は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
      </Box>
      <PrimaryHeading>第11条（利用規約の変更）</PrimaryHeading>
      <Box>
      ...
      <PrimaryHeading>第12条（通知または連絡）</PrimaryHeading>
      <Box>
        ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。
        当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
      </Box>
      <PrimaryHeading>第13条（権利義務の譲渡の禁止）</PrimaryHeading>
      <Box>
        ユーザーは、当方の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
      </Box>
      <PrimaryHeading>第14条（準拠法）</PrimaryHeading>
      <Box>本規約の解釈にあたっては、日本法を準拠法とします。</Box>
      <PrimaryHeading>第15条（お問い合わせ）</PrimaryHeading>
      <Box>
